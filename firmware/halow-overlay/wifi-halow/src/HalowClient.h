...
#ifndef _HalowCLIENT_H_
#define _HalowCLIENT_H_
...
class HalowClient : public ESPLwIPClient
{
protected:
    std::shared_ptr<HalowClientSocketHandle> clientSocketHandle;
    std::shared_ptr<HalowClientRxBuffer> _rxBuffer;
    bool _connected;
    bool _sse;
    int _timeout;
...
public:
    ...
    bool operator==(const HalowClient&);
    bool operator!=(const HalowClient& rhs)
    {
